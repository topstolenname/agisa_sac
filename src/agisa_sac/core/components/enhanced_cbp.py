...
#   AGI-SAC_Clean/src/agisa_sac/core/components/enhanced_cbp.py
#
...
# Calculate the path to the clean repository's enhanced_cbp.py
_base_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../../../'))
_clean_path = os.path.join(_base_path, 'AGI-SAC_Clean/src/agisa_sac/core/components/enhanced_cbp.py')

# Load the module directly from the clean repository using importlib
_spec = importlib.util.spec_from_file_location("_clean_enhanced_cbp", _clean_path)
if _spec is None or _spec.loader is None:
    raise ImportError(f"Could not load enhanced_cbp module from clean repository: {_clean_path}")
...
EnhancedContinuityBridgeProtocol = _clean_module.EnhancedContinuityBridgeProtocol

__all__ = ["EnhancedContinuityBridgeProtocol"]
